...
export default function Footer() {
  return (
    <div className="bg-[#666] fixed bottom-0 left-0 right-0  xl:flex-row mt-[12rem] lg:flex-row text-white flex sm:flex-col gap-8 sm:gap-5 min-[0px]:px-[4%] min-[0px]:flex-col text-center text-[1rem] justify-center py-6">
      <div>
