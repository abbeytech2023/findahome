...
export default function Root() {
  return (
    <div className="bg-[#666] xl:flex-row lg:flex-row text-white flex sm:flex-col gap-8 sm:gap-5 min-[0px]:px-[4%] min-[0px]:flex-col text-center text-[1rem] justify-center py-6">
      <div>
