...
function SideBarTabbed() {
  return (
    <div className="flex bg-[#555] absolute border-2 py-10 border-[rgba(20,76,111)]   flex-col gap-11  min-w-[200px] font-semibold cursor-pointer justify-center items-center  ">
