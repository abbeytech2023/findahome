...
function SideBarTabbed() {
  return (
    <div className="flex absolute border-2 py-10 border-[rgba(20,76,111)] bg-[rgba(11,20,25,0.8)]  flex-col gap-11  min-w-[200px] font-semibold cursor-pointer justify-center items-center  ">
